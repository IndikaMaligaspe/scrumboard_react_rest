...
function TaskDetails  (props) {
    ...
    let start = (props.task.started)? props.task.started : new Date().toLocaleDateString("en-US");
    let end =  (props.task.due)? props.task.due : new Date().toLocaleDateString("en-US");
